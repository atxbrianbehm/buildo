...
**Status:** Milestone 7E controller completed-family read-restore foundation
...
```text
typecheck: passed
unit tests: passed, 165 tests across 43 files
lint: passed
build: passed
